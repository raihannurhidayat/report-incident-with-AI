...
interface ReportFormSubmissionProps {
  data: any;
  onComplete: (data: any) => void;
}

const ReportFormSubmission = (props: ReportFormSubmissionProps) => {
  const { data, onComplete } = props;

  console.log({
    from: "report from submission",
    data,
  });

  const reportId = data.data.reportId || "ERROR-ID-NOT-FOUND";
  return (
